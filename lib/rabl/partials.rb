module Rabl
  module Partials
    ...
    def partial(file, options = {}, &block)
      ...
      engine = engine.render if engine.is_a?(Rabl::Engine)
      engine
    end
    ...
    def partial_as_engine(file, options = {}, &block)
      ...
      view_path = options[:view_path] || @_view_path
    ...
    def object_to_engine(object, options = {}, &block)
      ...
      Rabl::Engine.new(options[:source], options).apply(@_scope, :object => object, :locals => options[:locals], &block)
    end
